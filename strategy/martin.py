...
if __name__ == '__main__':
    ...
    # actuator.run(data, MartinStrategy, 'MartinStrategy_ETH_5m')
    # 参数优化
    space = dict(
        # 多加仓次数
    ...
    # 不同时间级别情况下的收益
    symbols = ['ETH', 'OP', 'ENS', 'BTC', 'APE', 'KNC', 'GMT']
    ...
    for interval in intervals:
        for symbol in symbols:
            ...
            param = strategy.Optimizer(data, space, create_martin, max_evals=500,
